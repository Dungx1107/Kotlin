package com.example.androiddeveloper.TipTime
...
//                .verticalScroll(rememberScrollState())
        ...
        EditNumberField(
            ...
            leadingIcon = R.drawable.outline_attach_money_24,
            value = amountInput,
        ...
        EditNumberField(
            ...
            leadingIcon = R.drawable.outline_humidity_percentage_24,
            keyboardOptions = KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number,
...
@Composable
fun EditNumberField(
    @StringRes label: Int, //ể biểu thị tham số label được kỳ vọng là tham chiếu tài nguyên chuỗi
